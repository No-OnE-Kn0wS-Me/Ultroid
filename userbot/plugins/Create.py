    ...
    if not grop.text[0].isalpha() and grop.text[0] not in ("/", "#", "@", "!"):
        ...
        if type_of_group == "b":
            ...
            try:
                ...
                await grop.edit("Your `{}` Master Your Group was Created Successfully!. Join [{}]({})".format(group_name, group_name, result.link))
            ...
            try:
                ...
                await grop.edit("Your `{}` Master, Your Group / Channel has been Successfully Created!. Join [{}]({})".format(group_name, group_name, result.link))
